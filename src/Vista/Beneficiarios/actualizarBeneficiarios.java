 ...
 * Date: 01-sep-2021
 */
public class actualizarBeneficiarios extends javax.swing.JDialog {
    ...
    public actualizarBeneficiarios(java.awt.Frame parent, boolean modal, String ageObra,int idInformacionObras, TablaObrasInformacion toi,int idBeneficiario) {
        super(parent, modal);
        initComponents();
        ...
        cbd.openConnection();
        tbf = cbd.obtenerBeneficiario(idBeneficiario);
        cbd.closeConnection();
...
//        campoLocalidad.setText(toi.getLocalidad());
        this.toi = toi;
        campoNombreCompleto.setText(tbf.getNombre());
        campoLocalidad.setText(tbf.getLocalidad());
        campoObra.setText(String.valueOf(tbf.getId_obra()));
    }
...
//        tbf.setCreated_at(new Timestamp(10000));
        cbd.openConnection();
        int operacionExitosa = cbd.actualizaBeneficiarios(tbf);
        cbd.closeConnection();
        if(operacionExitosa !=0){
            JOptionPane.showMessageDialog(null, "Todo listo. Beneficiario Actualizado.");
            this.dispose();
